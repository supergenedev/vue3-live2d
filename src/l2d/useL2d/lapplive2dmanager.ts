...
export class LAppLive2DManager {
   ...
   */
  public changeScene(ResourcesPath: string, ModelDir: string, center?: {x: number, y: number}, offDefaultMove?: boolean): void {
    if (LAppDefine.DebugLogEnable) {
    ...
    this._models.pushBack(new LAppModel(center, offDefaultMove));
    if (ModelDir) {
