<template>
  <div class="vue-live2d-container">
    ...
    <div>
      <p>Toggle image isOuterBackground</p>
      <button @click="isOuterBackground=!isOuterBackground">{{isOuterBackground ? 'Yes' : 'No'}}</button>
    </div>
    <div>
    ...
    <VueLive2d
      ...
      :model-dir="modelName"
      :zoom="zoom"
      :is-outer-background="isOuterBackground"
...
const isOuterBackground = ref(false);
